...
public class LinkedQueue<E> implements Queue<E> {
  ...
  /**
   * Appends all elements of Q2 onto the end of this queue in O(1) time,
   * leaving Q2 empty.
   *
   * @param Q2  another LinkedQueue whose contents will be moved here
   */
  public void concatenate(LinkedQueue<E> Q2) {
    // delegate to our underlying list’s concat
  ...
  public static void main(String[] args) {
    ...
    // Q1 should now be [1, 2, 3, 4]; Q2 should be empty.
    while (!Q1.isEmpty())
