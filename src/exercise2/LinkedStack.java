...
/**
 * Realization of a stack as an adaptation of a stacks.SinglyLinkedList.
...
public class LinkedStack<E> implements Stack<E> {
  ...
  /**
   * Transfers all elements from source stack S onto destination stack T,
   * so that the original top of S becomes the bottom of the transferred block in T.
   * After transfer, S will be empty.
   *
   * @param S the source stack to transfer from
   * @param T the destination stack to transfer to
