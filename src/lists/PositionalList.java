...
public interface PositionalList<E> extends Iterable<E> {
    ...
    /**
     * Returns the zero‐based index of the element at Position p,
     * or –1 if p is not found in this list.
     *
     * @param p  a Position of this list (may be null)
     * @return   the index of p, or ‐1 if p is not in the list
     * @throws IllegalArgumentException if p is non‐null but invalid
     */
